...
import img from "../assets/care_5.jpg"
    ...
    return(
        <>
         <Navbar />
            ...
            <p className='creating'>"Never be so busy as not to think of others"</p>
        </div>
        <div className='class'>
        ...
        <div>
            ...
            <b>Welcome..!</b> to our revolutionary Golden Year Companion, where event planning and execution 
